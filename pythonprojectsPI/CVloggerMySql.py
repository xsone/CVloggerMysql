...
#Functie voor schrijven data van Nefit Easycontrol via XMPP-protocol naar mySQL DB
def writeMysql():
...
while True:
    if ((time.time() - lastConnectionTime) >= postingInterval):
       ...
       if boilerStatusTxt == ['', '', '', ''] and boilerStatus == 1:
          ...
          print('Boiler UIT')
          writeMysql()
       if boilerStatusTxt == ['', 'maintenance', '', ''] and boilerStatus == 1:
          boilerStatus = 0
          print('Boiler UIT')
          writeMysql()   
       if boilerStatusTxt == ['', 'dhw on', '', '']: #and boilerStatus == 0:
          ...
          print('Boiler AAN')
          writeMysql()
       if boilerStatusTxt == ['', 'dhw on', 'maintenance', '']: #and boilerStatus == 0:
          boilerStatus = 1
          print('Boiler AAN')
          writeMysql()   
